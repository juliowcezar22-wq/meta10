import { ListChecks, ClipboardCheck, FileText, Network, BookOpen, ArrowUpRight, Gamepad2 } from 'lucide-react'
import { MATERIALS } from '@/lib/constants'

const iconMap: Record<string, React.ElementType> = { ListChecks, ClipboardCheck, FileText, Network, BookOpen, Gamepad2 }
      ...
      <div className="relative container-custom">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 md:gap-6">
          {MATERIALS.map((material, i) => {
            ...
            return (
              <div key={material.id} className={`group relative bg-gradient-to-br ${c.bg} rounded-2xl p-6 md:p-8 text-center cursor-pointer border ${c.border} transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lg`}>

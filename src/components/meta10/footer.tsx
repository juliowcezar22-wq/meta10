...
const navLinks = [
  ...
  { label: 'Materiais', href: '/materiais' }, { label: 'Loja', href: '/loja' },
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/80 text-sm leading-relaxed max-w-sm mb-6">
              Plataforma de reforço escolar de qualidade para alunos do ensino fundamental e médio. Conteúdo estratégico, questões e muito mais.
            </p>

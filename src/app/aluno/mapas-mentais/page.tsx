  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto w-full">
      <div className="mb-8">
        ...
        <p className="text-surface-500 mt-2">Escolha uma matéria para ver os mapas mentais disponíveis na loja.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        {subjects.map((sub) => {
          return (
            <Link 
              key={sub.id} 
              href={`/aluno/loja?tipo=mapa_mental&disciplina=${sub.id}`}

  ...
  return (
    <>
      ...
      <section className="section-padding bg-white text-center">
        <div className="container-custom">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Ainda com dúvidas?</h2>
          <p className="text-gray-600 mb-6">Fale conosco pelo WhatsApp e tire todas as suas dúvidas.</p>
